<template>
  <div v-if="isShowProps" class="row_nw_ce_ce config_container">
    <div v-if="editorConfig.currentParentComp && editorConfig.currentParentComp.componentType == 'html'"
      class="config_wraper">
    ...
    <div v-if="editorConfig.currentParentComp && editorConfig.currentParentComp.componentType == 'czml'"
      class="config_wraper">
      <div v-for="scitem in editorConfig.currentParentComp.properties" :key="scitem.id"
        ...
        <div v-for="czmlProp in scitem.properties" :key="czmlProp.id" class="col_nw_fs_ce czml_packet_box">
          <div v-if="czmlProp.isEntity" class="col_nw_ce_ce czml_entity_box">
            ...
            <div v-for="entityProp in czmlProp.properties" :key="entityProp.id"
          ...
          <div class="col_nw_ce_ce czml_packet_propbox">
