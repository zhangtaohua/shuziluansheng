  ...
  <div class="row_nw_ce_ce rparams_in_container">
    <div class="col_nw_fs_fs rparams_in_wrapper">
      ...
      <div class="col_nw_fs_ce rparams_in_body">
        ...
        <div v-if="currentTabName == htmlTabNames[0].value" class="rparams_in_body_code">
          <CodeEditor
            ref="codeEditorRef"
        ...
        <div v-if="currentTabName == htmlTabNames[1].value" class="col_nw_fs_fs rparams_in_body_wraper">
    ...
    () => {
      if (editorComponents.currentComp) {
        ...
        if (currentComp.value) {
          if (currentComp.value.styles) {
            const keys = Object.keys(currentComp.value.styles);
            keys.forEach((key) => {
              const values = Object.values(currentComp.value.styles[key].properties);
              values.forEach((prop: any) => {
                // if (prop.getStyleName() != "top" && prop.getStyleName() != "left" && prop.getStyleName() != "rotate") {
                style = style + prop.getStyleName("html") + ": ";
                style = style + prop.getStyleValue(false) + ";\r\n";
                // }
              });
            });
          }
