<template>
  <CommonWraper :vNodeData="props.vNodeData">
    <div ref="divRef" :class="divClassNames" :style="divStyles" @click="setEditorCurrentCompHd">
...
<script setup lang="ts">
  ...
  //   () => {
  //     if (editorComponents.currentComp && props.vNodeData && editorComponents.currentComp.id == props.vNodeData.id) {
