...
import {
  ...
  createInnerHalfAngleDoubleProp,
  createIntersectionWidthDoubleProp,
  createMaximumClockAngleDoubleProp,
  createMinimumClockAngleDoubleProp,
  createOuterHalfAngleDoubleProp,
...
export class czmlAgiConicSensorEntity {
  public id = "czml_entity_agi_conicSensor_" + nanoid(10);
  public name = "agi_conicSensor";
  public _czmlName = "agi_conicSensor";
  public labelZh = "圆锥传感器";
  public labelEn = "agi conic sensor";
  public title = "agi_conicSensor";
  public description = "A conical sensor volume taking into account occlusion of an ellipsoid, i.e., the globe.";
  public descriptionZh = "圆锥传感器";
  ...
  public properties = {
    ...
    innerHalfAngle: createInnerHalfAngleDoubleProp({
      isUsed: false,
      $ref: "../../Double.json",
      description: "The inner half angle of the cone.",
      default: 0.0,
    }),
    outerHalfAngle: createOuterHalfAngleDoubleProp({
      isUsed: false,
      $ref: "../../Double.json",
      description: "The outer half angle of the cone.",
      default: "π",
    }),
    minimumClockAngle: createMinimumClockAngleDoubleProp({
      isUsed: false,
      $ref: "../../Double.json",
      description: "The minimum clock angle limit of the cone.",
      default: 0.0,
    }),
    maximumClockAngle: createMaximumClockAngleDoubleProp({
      isUsed: false,
      $ref: "../../Double.json",
...
export default czmlAgiConicSensorEntity;
