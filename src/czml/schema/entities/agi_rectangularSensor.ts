...
import {
  ...
  createXHalfAngleDoubleProp,
  createYHalfAngleDoubleProp,
...
export class czmlAgiRectangularSensorEntity {
  public id = "czml_entity_agi_rectangularSensor_" + nanoid(10);
  public name = "agi_rectangularSensor";
  public _czmlName = "agi_rectangularSensor";
  public labelZh = "矩形传感器";
  public labelEn = "agi rectangular sensor";
  public title = "agi_rectangularSensor";
  public description = "A rectangular sensor volume taking into account occlusion of an ellipsoid, i.e., the globe.";
  public descriptionZh = "矩形传感器";
  ...
  constructor(options: any) {
    ...
    if (options.id) {
      ...
      this.id = "czml_entity_agi_rectangularSensor_" + options.name + "_" + nanoid(10);
    }
  ...
  public properties = {
    ...
    xHalfAngle: createXHalfAngleDoubleProp({
      isUsed: false,
      $ref: "../../Double.json",
      description: "The X half angle.",
      default: "π / 2",
    }),
    yHalfAngle: createYHalfAngleDoubleProp({
      isUsed: false,
      $ref: "../../Double.json",
...
export default czmlAgiRectangularSensorEntity;
