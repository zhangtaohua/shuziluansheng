...
import { createShowProp, createSizeInMetersProp } from "../properties/booleanProp";
import { createImageSubRegionProp } from "../properties/imageSubRegionProp";
import { createImageProp } from "../properties/urlProp";
import {
  createDisableDepthTestDistanceDoubleProp,
  createHeightIntegerPureProp,
  createRotationDoubleProp,
  createScaleDoubleProp,
  createWidthIntegerPureProp,
...
import { createAlignedAxisProp } from "../properties/alignedAxisProp";
import {
...
export class czmlBillboardEntity {
  ...
  public properties = {
    ...
    image: createImageProp({
      value: "https://images.pexels.com/photos/35046781/pexels-photo-35046781.jpeg",
      $ref: "Uri.json",
      description:
    ...
    alignedAxis: createAlignedAxisProp({
      isUsed: false,
    ...
    sizeInMeters: createSizeInMetersProp({
      isUsed: false,
      $ref: "Boolean.json",
      description:
    ...
    imageSubRegion: createImageSubRegionProp({
      isUsed: false,
