...
export class czmlCartesian4ListProp {
  public id = "czml_prop_cartesian4_list_" + nanoid(10);
  public name = "cartesian4";
  public _czmlName = "cartesian4";
  public labelZh = "XYZW坐标列表";
  ...
  public tag = "CzmlCartesian4ListPropInput";

  public unit = "meters";
  public _value = [[0, 0, 0, 0]];
  public _valueType = "cartesian4 list";
  ...
  constructor(options: any) {
    ...
    if (options.id) {
      ...
      this.id = "czml_prop_cartesian4_list_" + options.name + "_" + nanoid(10);
    }
...
export default czmlCartesian4ListProp;
