  ...
  <div v-if="isEnable" class="col_nw_fs_fs props_container">
    ...
    <div class="row_nw_ce_ce props_optionsbox">
      <div
        ...
        :class="{ props_labelboxs_disabled: !currentProp.isEnable }"
        @click="toggleIsShowOptions"
      >
        <div class="row_nw_fs_ce props_labelinboxs" :class="{ props_labelinboxs_disabled: !currentProp.isEnable }">
          {{ currentProp.value ? currentProp.value : "请选择" }}
        </div>
        <div class="row_nw_ce_ce props_labeldown">
          <div
            class="props_input_downarrow"
            :class="{
              props_input_downarrow_disabled: !currentProp.isEnable,
        ...
        >
          <div
            v-for="opt in currentProp.options"
            :key="opt.value"
            class="row_nw_fs_ce props_label_bigitem"
            :class="{ props_label_bigitem_act: currentProp.value == opt.value }"
