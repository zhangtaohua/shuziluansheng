...
<script setup lang="ts">
  ...
  function updatePureColorHd(color) {
    pureValue.value[0] = color;
  }

  function updateInterColorHd(color, index) {
    intervalsValues.value[index][1] = color;
  }

  function updateTimestrColorHd(color, index) {
    timestrIntervalsValues.value[index][1] = color;
  }
