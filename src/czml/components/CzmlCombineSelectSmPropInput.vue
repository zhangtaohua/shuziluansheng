<template>
  <div v-if="isEnable" :id="currentProp.id" class="col_nw_fs_fs czml_props_container">
...
<style scoped>
  ...
  .czml_combine_downarrow {
    ...
    border-top: 0.625rem solid rgba(255, 255, 255, 1);
  ...
  .czml_combine_downarrow_disabled {
    border-top: 0.625rem solid rgba(255, 255, 255, 0.5);
    cursor: not-allowed;
  }
