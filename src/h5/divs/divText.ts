...
import {
  createCssBottomProp,
  createCssFontSizeProp,
  createCssHeightProp,
  createCssLeftProp,
  createCssLineHeightProp,
  createCssRightProp,
  createCssRotateProp,
  createCssTextEllipseLinesProp,
  createCssToptProp,
  createCssWidthProp,
  createCssZIndexProp,
...
export class h5DivText {
  ...
  public labelZh = "文本";
  public labelEn = "text";
  public description = "A text box";
  public descriptionZh = "";

  public type = "h5";
  public componentType = "html";
  public componentProps = "h5#text";
  public tag = "CommonDivText";
  public h5Tag = "span";
