...
const tiandituKey = mapKeys.tiandituKey;

export const mapXYZUrl = {
  /****
   * 高德地图
   * lang可以通过zh_cn设置中文，en设置英文，size基本无作用，scl设置标注还是底图，scl=1代表注记， lang=zh_cn
  ...
  aMap_vec: "http://webrd0{1-4}.is.autonavi.com/appmaptile?size=1&scale=1&style=8&x={x}&y={y}&z={z}",
  ...
  aMap_cs_vec: "http://webrd0{s}.is.autonavi.com/appmaptile?size=1&scale=1&style=8&x={x}&y={y}&z={z}",
  ...
  aMap_vec_single: "http://webrd01.is.autonavi.com/appmaptile?size=1&scale=1&style=8&x={x}&y={y}&z={z}",
...
export const mapWMTSUrl = {
  tiandi_lnglat_vec: `https://t0.tianditu.gov.cn/vec_c/wmts?tk=${tiandituKey}`, //
  tiandi_lnglat_vec_zh_label: `https://t0.tianditu.gov.cn/cva_c/wmts?tk=${tiandituKey}`, //
  tiandi_lnglat_vec_en_label: `https://t0.tianditu.gov.cn/eva_c/wmts?&tk=${tiandituKey}`, //

  tiandi_lnglat_img: `https://t0.tianditu.gov.cn/img_c/wmts?tk=${tiandituKey}`, //
  tiandi_lnglat_img_zh_label: `https://t0.tianditu.gov.cn/cia_c/wmts?tk=${tiandituKey}`, //
  tiandi_lnglat_img_en_label: `https://t0.tianditu.gov.cn/eia_c/wmts?tk=${tiandituKey}`, //

  tiandi_spm_vec: `https://t0.tianditu.gov.cn/vec_w/wmts?tk=${tiandituKey}`, //
  tiandi_spm_vec_zh_label: `https://t0.tianditu.gov.cn/cva_w/wmts?tk=${tiandituKey}`, //
  tiandi_spm_vec_en_label: `https://t0.tianditu.gov.cn/eva_w/wmts?&tk=${tiandituKey}`, //

  tiandi_spm_img: `https://t0.tianditu.gov.cn/img_w/wmts?tk=${tiandituKey}`, //
  tiandi_spm_img_zh_label: `https://t0.tianditu.gov.cn/cia_w/wmts?tk=${tiandituKey}`, //
  tiandi_spm_img_en_label: `https://t0.tianditu.gov.cn/eia_w/wmts?tk=${tiandituKey}`, //
  ...
  tiandi_sp_img_full: `https://t0.tianditu.gov.cn/img_w/wmts?service=wmts&tk=${tiandituKey}&request=GetTile&version=1.0.0&LAYER=img&tileMatrixSet=w&TileMatrix={TileMatrix}&TileRow={TileRow}&TileCol={TileCol}&style=default&format=tiles`,
  tiandi_sp_img_zh_label_full: `https://t0.tianditu.gov.cn/cia_w/wmts?service=wmts&tk=${tiandituKey}&request=GetTile&version=1.0.0&LAYER=cia&tileMatrixSet=w&TileMatrix={TileMatrix}&TileRow={TileRow}&TileCol={TileCol}&style=default.jpg`,
  tiandi_sp_img_en_label_full: `https://t0.tianditu.gov.cn/eia_w/wmts?service=wmts&tk=${tiandituKey}&request=GetTile&version=1.0.0&LAYER=eia&tileMatrixSet=w&TileMatrix={TileMatrix}&TileRow={TileRow}&TileCol={TileCol}&style=default.jpg`,
