...
export const CesiumIondefaultAccessToken =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiI5MGMyNWE1Mi04ODk4LTQyMTktYjU4ZS1mN2Y1NGE4NGNjZjAiLCJpZCI6MjMzNzIwLCJpYXQiOjE3MjMxNzQwOTR9.wYPCrvT5riuLcXm8K8S5M6XZzhfcjA2926isD20-Al8";
...
export const csOnlySphereOptions = {
  language: "zh_CN",
...
export const csFullSphereOptions = {
  language: "zh_CN",
  pixelRatio: 1, //window.devicePixelRatio,
  viewMode: cesiumViewMode.scene3D,
  isShowtimeline: true,
