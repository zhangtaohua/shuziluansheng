...
import { cesiumViewMode, screenEventType } from "./csConstant";
...
export default class CsDrawLayers {
  ...
  public drawTipNodePopupHandler() {
    ...
    handler.setInputAction((event) => {
      if (this.isShowTipPopup) {
        ...
        if (Cesium.defined(cartesian)) {
          ...
          // callbackFunc(longitude, latitude, height);
          this.drawTipPopupOptions.position = [longitude, latitude, 0];
          this.vuePopupIns?.updateLayer(this.drawTipPopupOptions);
          this.vuePopupIns?.showPopupByID(this.drawTipPopupOptions.id);
        }
      }
  ...
  public drawPoint(pid: string, id: string, position: any) {
    const pointOpt = {
      ...
      point: {
        show: true,
        // color: Cesium.Color.RED,
        color: Cesium.Color.fromCssColorString("rgba(26, 255, 228, 1)"),
        pixelSize: 8,
        outlineColor: Cesium.Color.fromCssColorString("rgba(26, 255, 228, 1)"),
        disableDepthTestDistance: Number.POSITIVE_INFINITY,
        heightReference: Cesium.HeightReference.CLAMP_TO_GROUND,
      },
    };
  ...
  public drawPolyline(pid: string, id: string, positions: any) {
    ...
    const polylineOpt = {
      ...
      polyline: {
        ...
        width: 2.0,
        color: Cesium.Color.fromCssColorString("rgba(26, 255, 228, 1)"),
        depthFailMaterial: Cesium.Color.fromCssColorString("rgba(26, 255, 228, 1)"),
        clampToGround: true,
      },
    };
  ...
  public drawPolygon(pid: string, id: string, positions: any) {
    ...
    const polygonOpt = {
      ...
      polygon: {
        hierarchy: positions,
        color: Cesium.Color.fromCssColorString("rgba(26, 255, 228, 1)").withAlpha(0.15),
      },
    };
  ...
  public endDrawShape = (isDrawOnce = true) => {
    ...
    if (isDrawOnce) {
      ...
      this.drawTipPopupOptions.vNodeData.isStart = false;
      this.drawTipPopupOptions.vNodeData.status = "tipStart";
      ...
      this.drawTipPopupOptions.vNodeData.isStart = true;
      this.drawTipPopupOptions.vNodeData.status = "tipStart";
    }
  };
  ...
  public drawShape(options: DrawBasicOptions) {
    ...
    if (this.csBaseHandle) {
      ...
      if (shape == MAP_DRAW_POINT) {
        ...
        this.drawTipPopupOptions.vNodeData.isStart = true;
        this.drawTipPopupOptions.vNodeData.drawType = MAP_DRAW_POINT;
        this.drawTipPopupOptions.vNodeData.status = "tipStart";
        ...
        this.drawTipPopupOptions.vNodeData.isStart = true;
        this.drawTipPopupOptions.vNodeData.drawType = MAP_DRAW_SQUARE;
        this.drawTipPopupOptions.vNodeData.status = "tipStart";
        // 开启深度检测
        this.csBaseHandle.enableDepthTest();
        this.csBaseHandle.disableDoubleClick();
        ...
        this.drawHandler.setInputAction((clickEvent: any) => {
          if (!this.isStartDraw) {
            ...
            this.drawTipPopupOptions.vNodeData.status = "tipNext";
          }
        ...
        this.drawTipPopupOptions.vNodeData.isStart = true;
        this.drawTipPopupOptions.vNodeData.drawType = MAP_DRAW_RECTANGLE;
        this.drawTipPopupOptions.vNodeData.status = "tipStart";
        // 开启深度检测
        this.csBaseHandle.enableDepthTest();
        this.csBaseHandle.disableDoubleClick();
        ...
        this.drawTipPopupOptions.vNodeData.isStart = true;
        this.drawTipPopupOptions.vNodeData.drawType = MAP_DRAW_POLYGON;
        this.drawTipPopupOptions.vNodeData.status = "tipStart";
        // 开启深度检测
        this.csBaseHandle.enableDepthTest();
        this.csBaseHandle.disableDoubleClick();
        ...
        this.drawHandler.setInputAction((clickEvent: any) => {
          ...
          if (this.currentDrawPositions.length >= 3) {
            this.drawTipPopupOptions.vNodeData.status = "tipEnd";
            // 删除虚拟polygon
            if (this.lastLineAreaId) {
              this.removeDrawById(this.lastLineAreaId);
        ...
        this.drawTipPopupOptions.vNodeData.isStart = true;
        this.drawTipPopupOptions.vNodeData.drawType = MAP_DRAW_LINE;
        this.drawTipPopupOptions.vNodeData.status = "tipStart";
        // 开启深度检测
        // this.csBaseHandle.enableDepthTest();
        this.csBaseHandle.disableDoubleClick();
        ...
        this.drawTipPopupOptions.vNodeData.isStart = true;
        this.drawTipPopupOptions.vNodeData.drawType = MAP_DRAW_GEOMETRY_CIRCLE;
        this.drawTipPopupOptions.vNodeData.status = "tipStart";
        // 开启深度检测
        this.csBaseHandle.enableDepthTest();
        this.csBaseHandle.disableDoubleClick();
        ...
        this.drawHandler.setInputAction((clickEvent: any) => {
          ...
          if (this.currentDrawPositions.length == 2) {
            ...
            const lineId = this.createId(shape, "line", true);
            this.drawPolyline(this.currentLayerId, lineId, circlePoints);
            this.currentDrawEntitiesIds.push(lineId);
  ...
  public getDrawData = (options: DrawBasicOptions) => {
    return () => {
      ...
      if (shape == MAP_DRAW_POINT) {
        ...
        if (formatCoords && formatCoords.length && formatCoords[0].length <= 3) {
          formatCoords = [];
        }
