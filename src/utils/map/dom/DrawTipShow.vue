<template>
  <div v-if="props.vNodeData.isStart" :id="id" class="col_nw_center_center panel_container">
    ...
    <div
      v-else-if="
        props.vNodeData.drawType == MAP_DRAW_SQUARE ||
        props.vNodeData.drawType == MAP_DRAW_RECTANGLE ||
    ...
    <div
      v-else-if="props.vNodeData.drawType == MAP_DRAW_POLYGON || props.vNodeData.drawType == MAP_MEASURE_AREA"
      class="col_nw_center_center panel_wrapper"
    >
      <div v-if="props.vNodeData.status == 'tipStart'" class="row_nw_fs_center tip_title">点击开始</div>
      <div
        v-else-if="props.vNodeData.status == 'tipNext' || props.vNodeData.status == 'tipEnd'"
        class="row_nw_fs_center tip_title"
      >
        点击绘制下一点
      </div>
    ...
    <div
      v-else-if="props.vNodeData.drawType == MAP_DRAW_LINE || props.vNodeData.drawType == MAP_MEASURE_DISTANCE"
      class="col_nw_center_center panel_wrapper"
    >
      <div v-if="props.vNodeData.status == 'tipStart'" class="row_nw_fs_center tip_title">点击开始</div>
      <div
